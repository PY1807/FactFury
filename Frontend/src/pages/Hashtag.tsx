...
export const Hashtag = () => {
  ...
  useEffect(() => {
    const fetchSearchResults = async () => {
      ...
      try {
        setLoading(true);
        const response = await axios.get(`${BACKEND_URL}/api/hashtags`, {
          params: { query },
          headers: {
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-100">
        ...
        <div className="flex-grow container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">
            Trending Posts related to "#{query}"
          </h1>
      ...
      <div className="flex-grow container mx-auto px-4 py-8">
        ...
        {/* {loading ? (
                ...
                <div className="space-y-6">
                  {results.map(result => (
                    <div key={result.id} className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
